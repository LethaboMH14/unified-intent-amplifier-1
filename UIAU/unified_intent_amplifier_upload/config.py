...
# 5000:1 = strong visible smoothing for demo, intentional fast moves still pass
KALMAN_Q                 = 0.001   # Process noise (low = filter trusts its model)
KALMAN_R                 = 5.0     # Measurement noise (high = distrusts raw input)
KALMAN_VELOCITY_BYPASS_PX = 40     # Fast moves above this px bypass the filter
...
DEFAULT_TREMOR_SEVERITY = "moderate"
